      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <textarea value={form.internal_notes} onChange={e => set('internal_notes', e.target.value)}
              placeholder="Solo visibles para vos..." rows={3} />
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 flex items-start gap-3">
          ...
          <p className="text-xs text-blue-700 leading-relaxed">
            Al crear el turno se enviará automáticamente un email al paciente con los botones para confirmar o cancelar.
          </p>
        </div>

        <div className="flex gap-3">
          <Link href="/appointments" className="px-5 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-600 hover:bg-slate-50 transition-colors">
            Cancelar
          </Link>
